...
class PPOTransformerEvaluator:
    ...
    def calculate_benchmark_comparison(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Extract price data
            close_prices = eval_env.data[:, :, 0]  # Close is first feature
...
def main():
    ...
    eval_config = {
        ...
        'results_dir': 'evaluation_results/PPO_Transformer'
    }
    ...
    model_path = 'models/final_model_ppo_transformer.pkl'  # Update this path

    try:
        # Initialize evaluator
        evaluator = PPOTransformerEvaluator(model_path, eval_config)
