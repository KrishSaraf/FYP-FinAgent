"""
Plain RL LSTM Model Evaluation Script

This script evaluates trained Plain RL (REINFORCE) models with LSTM architecture
...
class PlainRLLSTMEvaluator:
    """Comprehensive evaluation class for Plain RL LSTM models with feature combinations"""
    ...
    def __init__(self, model_path: str, config: Dict[str, Any], selected_features: List[str] = None):
        ...
        logger.info("Plain RL LSTM Evaluator initialized successfully")
    ...
    def generate_performance_report(self, save_path: Optional[str] = None) -> str:
        ...
        # Generate report
        report = f"""
Plain RL LSTM Portfolio Model Evaluation Report
==============================================
...
"""
    ...
    def create_visualizations(self, save_dir: Optional[str] = None):
        ...
        fig.suptitle(f'Plain RL LSTM Model Evaluation Results\n{self.feature_combination}', 
