"""
OPTIMIZED Phase 2: Advanced Trading Strategies with 30 Most Important Features
Using only the most predictive features for better performance
"""
...
class OptimizedPortfolioEnv(gym.Env):
    """
    OPTIMIZED portfolio environment with 30 most important features
    ...
    def __init__(self, df_dict, stock_list, initial_amount=1000000.0):
        ...
        print(f"🎯 Using {len(self.trading_features)} optimized features per stock")
        print(f"   Features: {self.trading_features}")
...
def run_optimized_phase2():
    """
    Run OPTIMIZED Phase 2 with 30 most important features
    """
    print("🚀 OPTIMIZED Phase 2: Advanced Trading Strategies")
    print("=" * 60)
    ...
    env = OptimizedPortfolioEnv(df_dict, list(df_dict.keys()))
    ...
    print("   Training for 150000 timesteps...")
...
if __name__ == "__main__":
    success = run_optimized_phase2()
    
    if success:
        print("\n🎉 OPTIMIZED Phase 2 completed successfully!")
        print("✅ Advanced strategies with 30 features working!")
    else:
        print("\n🔧 Still needs work")
        print("💡 But now using the most important features!")