...
if __name__ == '__main__':
    ...
    num_cpu = 1  # Reduced to 1 to address CUDA out of memory error
    ...
    if RESUME_MODEL_PATH and os.path.exists(RESUME_MODEL_PATH):
        ...
        model = PPO(
            ...
            clip_range=0.05,      # Allow some movement
            clip_range_vf=0.05,   # Critic clipping
    ...
    print("✅ Action space [-1, 1] for short/long positions")
    print("✅ Intraday short position constraints")
    print("✅ Automatic short position closure at end of day")
    print("✅ 4% annual return on cash holdings (risk-free rate)")
    print("✅ Comprehensive error handling and edge cases")
    print("✅ GPU-optimized training with Stable-Baselines3")
    print("✅ Enhanced monitoring and logging")
    print("✅ Cash return tracking and reporting")
    print("✅ Automatic GPU detection and optimization")
    print("✅ Real-time GPU memory monitoring")
    print("✅ JAX + PyTorch GPU acceleration")
# Create directories to save logs and models
